...
export function MeshGradientBackground({
  className,
  children,
  colors = ["#B936F5", "#B936F5", "#B936F5", "#B936F5"],
  speed = 1,
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            left: "0%",
            top: "-20%",
            background: `radial-gradient(circle, ${colors[0]}40 10%, transparent 90%)`,
            filter: "blur(80px)",
        ...
        <div
          ...
          style={{
            right: "-25%",
            top: "10%",
            background: `radial-gradient(circle, ${colors[1]}35 10%, transparent 100%)`,
            filter: "blur(70px)",
        ...
        <div
          ...
          style={{
            left: "-30%",
            bottom: "-15%",
            background: `radial-gradient(circle, ${colors[2]}30 10%, transparent 100%)`,
            filter: "blur(90px)",
        ...
        <div
          ...
          style={{
            left: "30%",
            top: "80%",
            background: `radial-gradient(${colors[3] || colors[0]}30 10%, transparent 100%)`,
            filter: "blur(90px)",
